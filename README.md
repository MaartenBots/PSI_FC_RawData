...
________________________________________
Output Files
•	sorted_data.zip – The compressed archive containing all sorted files.
•	file_paths.csv – A CSV listing each TAR file, its original path, and its assigned category.
________________________________________
Need Help?
